...
impl<'a> Renderer<'a> for GqlFieldRenderer<'a> {
...
impl<'a> GqlFieldRenderer<'a> {
    fn render_input_field(&self, input_field: &InputField<'a>, ctx: &mut RenderContext<'a>) -> String {
    ...
    fn render_output_field(&self, field: &OutputField<'a>, ctx: &mut RenderContext<'a>) -> String {
    ...
    fn render_arguments(&self, args: &[InputField<'a>], ctx: &mut RenderContext<'a>) -> Vec<String> {
    ...
    fn render_argument(&self, arg: &InputField<'a>, ctx: &mut RenderContext<'a>) -> String {
