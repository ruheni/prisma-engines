...
impl JsonRequest {
    ...
    pub fn from_graphql(gql: &str, query_schema: &QuerySchema) -> TestResult<JsonSingleQuery> {
        ...
        let output = JsonSingleQuery {
            ...
            query: graphql_selection_to_json_field_query(selection, &schema_field, query_schema),
        };
...
fn graphql_selection_to_json_field_query<'a>(
...
fn graphql_args_to_json_args<'a>(
    selection: &mut Selection,
    args_fields: &[InputField<'a>],
    query_schema: &'a QuerySchema,
...
fn graphql_selection_to_json_selection<'a>(
    selection: Selection,
    schema_field: &OutputField<'a>,
    query_schema: &'a QuerySchema,
) -> SelectionSet {
